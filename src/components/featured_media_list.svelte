<script>
    ...
    //const _supabase = createClient('https://junovfrylildbzqvwoax.supabase.co',  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp1bm92ZnJ5bGlsZGJ6cXZ3b2F4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTY0NzQwMTAyOSwiZXhwIjoxOTYyOTc3MDI5fQ.YRIlrai7CJju3v1ZXnvrmHolCprYt73FbfgreQ-u89c');
...
{:then data}
  {#each data as entry, i}
    {#if entry.released == true && entry.featured == true }
    <div class="tile">
